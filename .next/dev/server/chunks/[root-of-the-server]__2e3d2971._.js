...
async function GET(request) {
    ...
    if (breadcrumbs) {
        const crumbs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$landrop$2f$lib$2f$file$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBreadcrumbs"])(breadcrumbs);
    ...
    const folders = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$landrop$2f$lib$2f$file$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFolders"])(parentId);
...
async function POST(request) {
    try {
        ...
        // ID is not used in creation for fs-based store, but we need to construct the object
        // The actual ID (path) will be determined by where it's created
        const folder = {
            id: "",
            name,
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$landrop$2f$lib$2f$file$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addFolder"])(folder);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2e3d2971._.js.map