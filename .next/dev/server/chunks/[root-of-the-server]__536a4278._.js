...
"[project]/landrop/app/api/files/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    const file = (0, __TURBOPACK__imported__module__$5b$project$5d2f$landrop$2f$lib$2f$file$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFile"])(id);
    if (!file) {
    ...
    const compressedData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$landrop$2f$lib$2f$compression$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["base64ToUint8Array"])(file.data);
    const decompressedData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$landrop$2f$lib$2f$compression$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decompressData"])(compressedData);
    return new __TURBOPACK__imported__module__$5b$project$5d2f$landrop$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](decompressedData, {
        headers: {
            "Content-Type": file.type,
            "Content-Disposition": `attachment; filename="${encodeURIComponent(file.originalName)}"`,
            "Content-Length": decompressedData.length.toString()
        }
    });
}
async function DELETE(request, { params }) {
    const { id } = await params;
    const success = (0, __TURBOPACK__imported__module__$5b$project$5d2f$landrop$2f$lib$2f$file$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteFile"])(id);
    if (!success) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$landrop$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "File not found"
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__536a4278._.js.map