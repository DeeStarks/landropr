...
"[project]/landrop/app/api/network/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const interfaces = __TURBOPACK__imported__module__$5b$externals$5d2f$os__$5b$external$5d$__$28$os$2c$__cjs$29$__["default"].networkInterfaces();
        let networkAddress = "localhost:3000";
        ...
        for (const name of Object.keys(interfaces)){
            ...
            for (const alias of iface){
                if (alias.family === "IPv4" && !alias.internal) {
                    networkAddress = `${alias.address}:3000`;
                    break;
                }
            }
            if (networkAddress !== "localhost:3000") break;
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0a6b84d8._.js.map