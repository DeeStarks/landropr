...
async function GET(request, { params }) {
    try {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$landrop$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](fileBuffer, {
            headers: {
...
async function DELETE(request, { params }) {
    const { id: encodedId } = await params;
    const id = decodeURIComponent(encodedId);
    const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$landrop$2f$lib$2f$file$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteFile"])(id);
    if (!success) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$landrop$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "File not found"
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fa056f37._.js.map